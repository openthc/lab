...
<div class="container">
	...
	<div class="mb-2">
		...
		<input class="form-control" name="qbench-server-url" value="https://..." >
	</div>

	<div class="mb-2">
		<label>QBench Public Key</label>
		<input class="form-control" name="qbench-public-key" value="">
	</div>

	<div class="mb-2">
		<label>QBench Secret Key</label>
		<input class="form-control" name="qbench-secret-key" value="">
	</div>
