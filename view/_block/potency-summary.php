...
if ($thc > 0) {
	$uom = UOM::nice($data['Lab_Result_Metric_list']['018NY6XC00PXG4PH0TXS014VVW']['uom']);
...
// if ($cbd > 0) {
	$uom = UOM::nice($data['Lab_Result_Metric_list']['018NY6XC00DEEZ41QBXR2E3T97']['uom']);
...
$uom = UOM::nice($data['Lab_Result_Metric_list']['018NY6XC00SAE8Q4JSMF40YSZ3']['uom']);
...
<div class="row card-wrap potency-result-cards">
	<div class="col">
		<div class="card">
			<div class="card-body">
				<h2 class="c" style="margin:0;" title="Activated Total THC">THC:
	...
	<div class="col">
		<div class="card">
			<div class="card-body">
				<h2 class="c" style="margin:0;" title="Activated Total CBD">CBD:
	...
	<div class="col">
		<div class="card">
			<div class="card-body">
				<h2 class="c" style="margin:0;" title="Activated Total Cannabinoids">Total:
